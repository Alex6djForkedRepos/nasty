...
mod tests {
    ...
    #[test]
    fn verifies_argon2_0_5_default_phc_string() {
        // Generated by argon2 0.5.3 defaults with a fixed [0u8; 16] test salt.
        let hash = "$argon2id$v=19$m=19456,t=2,p=1$AAAAAAAAAAAAAAAAAAAAAA\
                    $vK9v0OWqoxsnIkDDgGdlMxPp94AvwibM+EFs97z55kQ";

        verify_password("correct horse battery staple", hash).expect("verify existing hash");
    }
